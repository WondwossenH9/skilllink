...
resource "aws_cloudwatch_metric_alarm" "load_balancer_5xx" {
  alarm_name          = "${var.project_name}-${var.environment}-lb-5xx-errors"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
  ...
  tags = {
    Name = "${var.project_name}-${var.environment}-lb-5xx-alarm"
  }
}

resource "aws_cloudwatch_metric_alarm" "load_balancer_response_time" {
  alarm_name          = "${var.project_name}-${var.environment}-lb-response-time"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
  ...
  tags = {
    Name = "${var.project_name}-${var.environment}-lb-response-time-alarm"
  }
}
